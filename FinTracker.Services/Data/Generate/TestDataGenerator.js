...
const categories = [
    ...
    },
    {
        ...
        memo: () =>
            getRandomElement([
                "Interact Purchase: Superstore",
                "Interact Purchase: Safeway",
            ]),
    },
    {
        categoryId: 4,
        ...
        memo: () =>
            getRandomElement([
                ...
                "The Galactic Donut",
                "Unicorn Udon Noodle House",
                "Bacon Me Crazy Diner",
            ]),
    },
    {
        categoryId: 5,
    ...
    },
    {
        ...
        memo: () =>
            getRandomElement(["Diese Onze", "Upstairs Jazz Bar and Grill"]),
    },
    {
        categoryId: 10,
...
function writeTransactionsToSql(output, fileName) {
    const sqlOutput = output
        .map(
            (t) =>
                `insert into dbo.TblTransaction (Date, Memo, Amount, CategoryId) values ('${t.date}', '${t.memo}', ${Math.floor(t.amount * 100)}, ${t.categoryId});`
        )
        .join("\n");
