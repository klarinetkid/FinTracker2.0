...
function CategoryTableRow(props: CategoryTableRowProps) {
    return (
        <tr>
            ...
            <td className="category-table-name centre" onClick={() => props.editCategory(props.category)}>
                <CategoryPill category={props.category} />
            </td>
            <td className="centre monospace">
                #{props.category.colour}
            </td>
            <td className="ralign">
                {props.category.transactionCount}
            </td>
        </tr>
    );
}
